...
CREATE TABLE `users` (
  ...
  `smtp_host`         VARCHAR(255)    DEFAULT NULL COMMENT 'Servidor SMTP del usuario',
  `smtp_port`         SMALLINT        DEFAULT 587  COMMENT 'Puerto SMTP',
  `smtp_email`        VARCHAR(255)    DEFAULT NULL COMMENT 'Email SMTP para envío',
  `smtp_password`     VARCHAR(500)    DEFAULT NULL COMMENT 'Contraseña o App Password SMTP',
  `smtp_encryption`   ENUM('tls','ssl','none') DEFAULT 'tls' COMMENT 'Tipo de encriptación',
  `smtp_from_name`    VARCHAR(200)    DEFAULT NULL COMMENT 'Nombre mostrado al enviar',
