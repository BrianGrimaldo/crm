                        ...
                        <tr>
                            ...
                            <td>
                                <div style="display: flex; gap: 0.5rem; align-items: center;">
                                    <a href="<?= url('/roles/edit?id=' . $role->id) ?>" style="color: var(--primary-hover); text-decoration: none; font-weight: 600;">Permisos</a>
                                    <?php if (!$role->is_system): ?>
                                        <form action="<?= url('/roles/delete') ?>" method="POST" onsubmit="return confirm('¿Eliminar este rol? Los usuarios asignados perderán sus permisos.');" style="display:inline; margin:0;">
