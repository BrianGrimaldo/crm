                                ...
                                <div class="activity-details"
                                    ...
                                    <div>
                                        <div class="activity-desc">
                                            <strong
                                                style="color: var(--text-main);"><?= htmlspecialchars($task->title) ?></strong>
                                        </div>
                                        <div class="activity-time" style="margin-top: 0.2rem;">
                                            ...
                                            <?php endif; ?>
                                            &bull; <strong
                                                style="color:#ef4444;"><?= date('h:i A', strtotime($task->due_date)) ?></strong>
                                        </div>
                                    </div>
                                    <form action="<?= url('/tareas/complete') ?>" method="POST">
                                        ...
                                        <button type="submit" class="btn"
                                            style="background: var(--border); padding: 0.3rem 0.6rem; color: #166534;"
                                            title="Completar">
                    ...
                    <?php else: ?>
                        <div style="text-align:center;color:#94a3b8;padding:2rem;">
                            <i class="fas fa-glass-cheers"
                                style="font-size: 2rem; margin-bottom: 0.5rem; color: var(--text-muted);"></i><br>
