...
<div class="page-header">
    ...
    <a href="<?= url('/configuracion/embudo/create') ?>" class="btn btn-primary">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="<?= url('/configuracion/embudo/edit?id=' . $stage->id) ?>" class="btn" style="padding: 0.4rem 0.8rem; background: var(--border); color: var(--text-main);">
