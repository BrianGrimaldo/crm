...
<div class="page-header">
    ...
    <div style="display: flex; gap: 1rem;">
        <a href="/crm_einsurglobal/public/oportunidades/pipeline" class="btn btn-outline" style="background: var(--surface); color: var(--text-main); border: 1px solid var(--border);">
...
<div class="card" style="box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); border-radius: 16px;">
    <div style="padding: 1.5rem; border-bottom: 1px solid var(--border); display: flex; gap: 1rem; background: var(--surface); border-top-left-radius: 16px; border-top-right-radius: 16px;">
        <form action="/crm_einsurglobal/public/oportunidades" method="GET" style="display: flex; gap: 1rem; flex: 1; flex-wrap: wrap;">
            ...
            <?php if (!empty($_GET['search']) || !empty($_GET['status'])): ?>
                <a href="/crm_einsurglobal/public/oportunidades" class="btn" style="background: var(--border); color: var(--text-main); flex-grow: 1; justify-content: center;">Limpiar</a>
            <?php endif; ?>
        </form>
    </div>
            ...
            <tbody>
                ...
                <?php else: ?>
                    <?php foreach ($deals as $deal): ?>
                        ...
                        <tr>
                            <td>
                                <a href="/crm_einsurglobal/public/oportunidades/edit?id=<?= $deal->id ?>" class="deal-name">
                            ...
                            <td>
                                <div style="display: flex; gap: 0.5rem; align-items: center;">
                                    <?php if (\App\Core\Permission::has('deals', 'update')): ?>
                                        <a href="/crm_einsurglobal/public/oportunidades/edit?id=<?= $deal->id ?>" class="action-btn action-edit">
