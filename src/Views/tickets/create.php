...
<div class="card" style="padding: 2rem;">
    <form action="/crm_einsurglobal/public/tickets" method="POST">
        ...
        <div style="display: flex; justify-content: flex-end; gap: 1rem;">
            <a href="/crm_einsurglobal/public/tickets" class="btn" style="background: var(--border); color: var(--text-main);">Cancelar</a>
