...
<div class="card">
    <div style="padding: 1.5rem; border-bottom: 1px solid var(--border); display: flex; gap: 1rem;">
        <form action="/crm_einsurglobal/public/organizaciones" method="GET" style="display: flex; gap: 1rem; flex: 1;">
            ...
            <?php if (!empty($_GET['search']) || !empty($_GET['type'])): ?>
                <a href="/crm_einsurglobal/public/organizaciones" class="btn" style="background: var(--border); color: var(--text-main);">Limpiar</a>
            <?php endif; ?>
        </form>
    </div>
